...
@Component({
  selector: 'app-fence-file-view',
  templateUrl: './fence-file-view.component.html',
  styleUrls: ['./fence-file-view.component.scss'],
  providers: []
})

export class FenceFileViewComponent extends AppBaseComponent implements OnInit {
...
constructionMaterialSelectOptions: MaterialSelectOptions;
  ...
  constructor(injector: Injector,
    ...
    @Optional() public dialogRef: MatDialogRef<FenceFileViewComponent>,
  ...
  buildingCode : [this.selectedFenceFile.buildingCode],
  fenceCode : [this.selectedFenceFile.fenceCode],
  fenceHight : [this.selectedFenceFile.fenceHight],
  northSideLength : [this.selectedFenceFile.northSideLength],
  southSideLength : [this.selectedFenceFile.southSideLength],
  eastSideLength : [this.selectedFenceFile.eastSideLength],
  westSideLength : [this.selectedFenceFile.westSideLength],
  northEastSideLength : [this.selectedFenceFile.northEastSideLength],
  southEastSidelength : [this.selectedFenceFile.southEastSidelength],
  northWestLength : [this.selectedFenceFile.northWestLength],
  southWestLength : [this.selectedFenceFile.southWestLength],
  regionalCenterCode : [this.selectedFenceFile.regionalCenterCode],
  branchCode : [this.selectedFenceFile.branchCode],
  fenceStatusCode : [this.selectedFenceFile.fenceStatusCode],
  ...
  disableControls() {
    for (const control of Object.keys(this.fenceFileForm.controls)) {
      this.fenceFileForm.controls[control].disable();
    }
  }
