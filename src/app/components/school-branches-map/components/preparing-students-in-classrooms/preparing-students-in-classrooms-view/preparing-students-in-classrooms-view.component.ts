...
@Component({
  selector: 'app-preparing-students-in-classrooms-view',
  templateUrl: './preparing-students-in-classrooms-view.component.html',
  styleUrls: ['./preparing-students-in-classrooms-view.component.scss'],
  providers: []
})

export class PreparingStudentsInClassroomsViewComponent extends AppBaseComponent implements OnInit {
...
studentsKindSelectOptions: MaterialSelectOptions;
  ...
  constructor(injector: Injector,
    ...
    @Optional() public dialogRef: MatDialogRef<PreparingStudentsInClassroomsViewComponent>,
  ...
  buildingCode : [this.selectedPreparingStudentsInClassrooms.buildingCode],
  periodNumber : [this.selectedPreparingStudentsInClassrooms.periodNumber],
  teamsNumber : [this.selectedPreparingStudentsInClassrooms.teamsNumber],
  girlsNumber : [this.selectedPreparingStudentsInClassrooms.girlsNumber],
  boysNumber : [this.selectedPreparingStudentsInClassrooms.boysNumber],
  total : [this.selectedPreparingStudentsInClassrooms.total],
  totalRecorded : [this.selectedPreparingStudentsInClassrooms.totalRecorded],
  stage : [this.selectedPreparingStudentsInClassrooms.stage],
  classroom : [this.selectedPreparingStudentsInClassrooms.classroom],
  studentsKind : [this.selectedPreparingStudentsInClassrooms.studentsKind]
      });
  ...
  disableControls() {
    for (const control of Object.keys(this.preparingStudentsInClassroomsForm.controls)) {
      this.preparingStudentsInClassroomsForm.controls[control].disable();
    }
  }
