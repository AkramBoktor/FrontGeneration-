...
@Component({
  selector: 'app-chairman-visa-new',
  templateUrl: './chairman-visa-new.component.html',
  styleUrls: ['./chairman-visa-new.component.scss'],
  providers: [
    ]
})

export class ChairmanVisaNewComponent extends AppBaseComponent implements OnInit {
...
showResultSelectOptions: MaterialSelectOptions;
  ...
  constructor(injector: Injector,
    @Optional() public dialogRef: MatDialogRef<ChairmanVisaNewComponent>,
  ...
  onSubmit() {
    this.chairmanVisaService.create(this.chairmanVisaForm.value)
        .pipe(switchMap(x => {
