...
@Component({
  selector: 'app-employee-contract-renewal-data-edit',
  templateUrl: './employee-contract-renewal-data-edit.component.html',
  styleUrls: ['./employee-contract-renewal-data-edit.component.scss'],
  providers: []
})

export class EmployeeContractRenewalDataEditComponent extends AppBaseComponent implements OnInit {
...
renewalTypeSelectOptions: MaterialSelectOptions;
  ...
  constructor(injector: Injector,
    ...
    @Optional() public dialogRef: MatDialogRef<EmployeeContractRenewalDataEditComponent>,
  ...
  id : [this.selectedEmployeeContractRenewalData.id],
  ...
  onSubmit() {
    this.employeeContractRenewalDataService.update(this.employeeContractRenewalDataForm.value, this.getControls('id').value)
    .pipe(switchMap(x => {
