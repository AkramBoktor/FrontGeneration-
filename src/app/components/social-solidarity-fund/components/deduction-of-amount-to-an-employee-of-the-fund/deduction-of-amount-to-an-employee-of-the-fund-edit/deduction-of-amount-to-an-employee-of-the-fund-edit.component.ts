...
@Component({
  selector: 'app-deduction-of-amount-to-an-employee-of-the-fund-edit',
  templateUrl: './deduction-of-amount-to-an-employee-of-the-fund-edit.component.html',
  styleUrls: ['./deduction-of-amount-to-an-employee-of-the-fund-edit.component.scss'],
  providers: []
})

export class DeductionOfAmountToAnEmployeeOfTheFundEditComponent extends AppBaseComponent implements OnInit {
...
bankCodeSelectOptions: MaterialSelectOptions;
  ...
  constructor(injector: Injector,
    ...
    @Optional() public dialogRef: MatDialogRef<DeductionOfAmountToAnEmployeeOfTheFundEditComponent>,
  ...
  id : [this.selectedDeductionOfAmountToAnEmployeeOfTheFund.id],
  ...
  onSubmit() {
    this.deductionOfAmountToAnEmployeeOfTheFundService.update(this.deductionOfAmountToAnEmployeeOfTheFundForm.value, this.getControls('id').value)
    .pipe(switchMap(x => {
