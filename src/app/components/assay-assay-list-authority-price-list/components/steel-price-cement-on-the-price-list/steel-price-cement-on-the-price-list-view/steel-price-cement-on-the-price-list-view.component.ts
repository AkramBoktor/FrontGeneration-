...
@Component({
  selector: 'app-steel-price-cement-on-the-price-list-view',
  templateUrl: './steel-price-cement-on-the-price-list-view.component.html',
  styleUrls: ['./steel-price-cement-on-the-price-list-view.component.scss'],
  providers: []
})

export class SteelPriceCementOnThePriceListViewComponent extends AppBaseComponent implements OnInit {
...
materialTypeSelectOptions: MaterialSelectOptions;
  ...
  constructor(injector: Injector,
    ...
    @Optional() public dialogRef: MatDialogRef<SteelPriceCementOnThePriceListViewComponent>,
  ...
  pricingYear : [this.selectedSteelPriceCementOnThePriceList.pricingYear],
  price : [this.selectedSteelPriceCementOnThePriceList.price],
  materialType : [this.selectedSteelPriceCementOnThePriceList.materialType]
      });
  ...
  disableControls() {
    for (const control of Object.keys(this.steelPriceCementOnThePriceListForm.controls)) {
      this.steelPriceCementOnThePriceListForm.controls[control].disable();
    }
  }
