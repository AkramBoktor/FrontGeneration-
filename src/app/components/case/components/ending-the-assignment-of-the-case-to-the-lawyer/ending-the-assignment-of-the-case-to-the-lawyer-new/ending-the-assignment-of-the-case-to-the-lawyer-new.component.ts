...
@Component({
  selector: 'app-ending-the-assignment-of-the-case-to-the-lawyer-new',
  templateUrl: './ending-the-assignment-of-the-case-to-the-lawyer-new.component.html',
  styleUrls: ['./ending-the-assignment-of-the-case-to-the-lawyer-new.component.scss'],
  providers: [
    ]
})

export class EndingTheAssignmentOfTheCaseToTheLawyerNewComponent extends AppBaseComponent implements OnInit {
...
caseReasonSelectOptions: MaterialSelectOptions;
  ...
  constructor(injector: Injector,
    @Optional() public dialogRef: MatDialogRef<EndingTheAssignmentOfTheCaseToTheLawyerNewComponent>,
  ...
  onSubmit() {
    this.endingTheAssignmentOfTheCaseToTheLawyerService.create(this.endingTheAssignmentOfTheCaseToTheLawyerForm.value)
        .pipe(switchMap(x => {
