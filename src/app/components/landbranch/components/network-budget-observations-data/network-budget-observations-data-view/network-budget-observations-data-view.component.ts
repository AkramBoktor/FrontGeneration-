...
@Component({
  selector: 'app-network-budget-observations-data-view',
  templateUrl: './network-budget-observations-data-view.component.html',
  styleUrls: ['./network-budget-observations-data-view.component.scss'],
  providers: []
})

export class NetworkBudgetObservationsDataViewComponent extends AppBaseComponent implements OnInit {
...
borderCodeSelectOptions: MaterialSelectOptions;
  ...
  constructor(injector: Injector,
    ...
    @Optional() public dialogRef: MatDialogRef<NetworkBudgetObservationsDataViewComponent>,
  ...
  landID : [this.selectedNetworkBudgetObservationsData.landID],
  averageHeightValues : [this.selectedNetworkBudgetObservationsData.averageHeightValues],
  averageValuesDecline : [this.selectedNetworkBudgetObservationsData.averageValuesDecline],
  networkNoteTypeCode : [this.selectedNetworkBudgetObservationsData.networkNoteTypeCode],
  borderCode : [this.selectedNetworkBudgetObservationsData.borderCode]
      });
  ...
  disableControls() {
    for (const control of Object.keys(this.networkBudgetObservationsDataForm.controls)) {
      this.networkBudgetObservationsDataForm.controls[control].disable();
    }
  }
