...
@Component({
  selector: 'app-price-for-new-item-new',
  templateUrl: './price-for-new-item-new.component.html',
  styleUrls: ['./price-for-new-item-new.component.scss'],
  providers: [
    ]
})

export class PriceForNewItemNewComponent extends AppBaseComponent implements OnInit {
...
unitSelectOptions: MaterialSelectOptions;
  ...
  constructor(injector: Injector,
    @Optional() public dialogRef: MatDialogRef<PriceForNewItemNewComponent>,
  ...
  onSubmit() {
    this.priceForNewItemService.create(this.priceForNewItemForm.value)
        .pipe(switchMap(x => {
