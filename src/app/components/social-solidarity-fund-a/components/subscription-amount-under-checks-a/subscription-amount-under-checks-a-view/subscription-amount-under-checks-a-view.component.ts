...
@Component({
  selector: 'app-subscription-amount-under-checks-a-view',
  templateUrl: './subscription-amount-under-checks-a-view.component.html',
  styleUrls: ['./subscription-amount-under-checks-a-view.component.scss'],
  providers: []
})

export class SubscriptionAmountUnderChecksAViewComponent extends AppBaseComponent implements OnInit {
...
issuerSelectOptions: MaterialSelectOptions;
  ...
  constructor(injector: Injector,
    ...
    @Optional() public dialogRef: MatDialogRef<SubscriptionAmountUnderChecksAViewComponent>,
  ...
  employeeCode : [this.selectedSubscriptionAmountUnderChecksA.employeeCode],
  ...
  periodStartDate : [this.selectedSubscriptionAmountUnderChecksA.periodStartDate],
  periodEndDate : [this.selectedSubscriptionAmountUnderChecksA.periodEndDate],
  checkNumber : [this.selectedSubscriptionAmountUnderChecksA.checkNumber],
  checkDate : [this.selectedSubscriptionAmountUnderChecksA.checkDate],
  amountValue : [this.selectedSubscriptionAmountUnderChecksA.amountValue],
  ...
  issuer : [this.selectedSubscriptionAmountUnderChecksA.issuer]
      });
  ...
  disableControls() {
    for (const control of Object.keys(this.subscriptionAmountUnderChecksAForm.controls)) {
      this.subscriptionAmountUnderChecksAForm.controls[control].disable();
    }
  }
