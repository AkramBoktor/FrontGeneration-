...
@Component({
  selector: 'app-end-of-a-special-vacation-for-employee-a-list',
  templateUrl: './end-of-a-special-vacation-for-employee-a-list.component.html',
  styleUrls: ['./end-of-a-special-vacation-for-employee-a-list.component.scss'],
  providers: []
})

export class EndOfASpecialVacationForEmployeeAListComponent extends AppBaseComponent implements OnInit {
...
terminationTypeSelectOptions: MaterialSelectOptions;
  ...
  gridHeaderOptions = new GridHeaderOptions({
    viewDialogClassType: EndOfASpecialVacationForEmployeeAViewComponent,
    editDialogClassType: EndOfASpecialVacationForEmployeeAEditComponent,
    newDialogClassType: EndOfASpecialVacationForEmployeeANewComponent,
  });
    constructor(
        injector: Injector,
  ...
  getEndOfASpecialVacationForEmployeesPaginatedSortedFiltered = (arg: GridPaginatedSortedFiltered): Observable<EndOfASpecialVacationForEmployeeA[]> => {
    return this.endOfASpecialVacationForEmployeeAService.getAllWithFilter(arg);
  }

  onDeleteClicked(param): void {
    this.endOfASpecialVacationForEmployeeAService.delete(param.data.id)
      .pipe(take(1))
