...
@Component({
  selector: 'app-health-unit-data-new',
  templateUrl: './health-unit-data-new.component.html',
  styleUrls: ['./health-unit-data-new.component.scss'],
  providers: [
    ]
})

export class HealthUnitDataNewComponent extends AppBaseComponent implements OnInit {
...
projectTypeSelectOptions: MaterialSelectOptions;
  ...
  constructor(injector: Injector,
    @Optional() public dialogRef: MatDialogRef<HealthUnitDataNewComponent>,
  ...
  onSubmit() {
    this.healthUnitDataService.create(this.healthUnitDataForm.value)
        .pipe(switchMap(x => {
