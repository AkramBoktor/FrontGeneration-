...
@Component({
  selector: 'app-approval-for-equipping-schools-approvals-view',
  templateUrl: './approval-for-equipping-schools-approvals-view.component.html',
  styleUrls: ['./approval-for-equipping-schools-approvals-view.component.scss'],
  providers: []
})

export class ApprovalForEquippingSchoolsApprovalsViewComponent extends AppBaseComponent implements OnInit {
...
branchSelectOptions: MaterialSelectOptions;
  ...
  constructor(injector: Injector,
    ...
    @Optional() public dialogRef: MatDialogRef<ApprovalForEquippingSchoolsApprovalsViewComponent>,
  ...
  disableControls() {
    for (const control of Object.keys(this.approvalForEquippingSchoolsApprovalsForm.controls)) {
      this.approvalForEquippingSchoolsApprovalsForm.controls[control].disable();
    }
  }
