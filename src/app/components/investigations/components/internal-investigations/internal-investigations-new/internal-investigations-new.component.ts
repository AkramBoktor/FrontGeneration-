...
@Component({
  selector: 'app-internal-investigations-new',
  templateUrl: './internal-investigations-new.component.html',
  styleUrls: ['./internal-investigations-new.component.scss'],
  providers: [
    ]
})

export class InternalInvestigationsNewComponent extends AppBaseComponent implements OnInit {
...
categorySelectOptions: MaterialSelectOptions;
  ...
  constructor(injector: Injector,
    @Optional() public dialogRef: MatDialogRef<InternalInvestigationsNewComponent>,
  ...
  onSubmit() {
    this.internalInvestigationsService.create(this.internalInvestigationsForm.value)
        .pipe(switchMap(x => {
