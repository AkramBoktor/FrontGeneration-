...
@Component({
  selector: 'app-building-models-works-view',
  templateUrl: './building-models-works-view.component.html',
  styleUrls: ['./building-models-works-view.component.scss'],
  providers: []
})

export class BuildingModelsWorksViewComponent extends AppBaseComponent implements OnInit {
...
unitCodeSelectOptions: MaterialSelectOptions;
  ...
  constructor(injector: Injector,
    ...
    @Optional() public dialogRef: MatDialogRef<BuildingModelsWorksViewComponent>,
  ...
  modelCode : [this.selectedBuildingModelsWorks.modelCode],
  activityType : [this.selectedBuildingModelsWorks.activityType],
  itemName : [this.selectedBuildingModelsWorks.itemName],
  amount : [this.selectedBuildingModelsWorks.amount],
  workType : [this.selectedBuildingModelsWorks.workType],
  itemCode : [this.selectedBuildingModelsWorks.itemCode],
  ...
  disableControls() {
    for (const control of Object.keys(this.buildingModelsWorksForm.controls)) {
      this.buildingModelsWorksForm.controls[control].disable();
    }
  }
