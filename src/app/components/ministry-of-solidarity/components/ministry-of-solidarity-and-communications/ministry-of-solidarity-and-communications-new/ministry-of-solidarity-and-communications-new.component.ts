...
@Component({
  selector: 'app-ministry-of-solidarity-and-communications-new',
  templateUrl: './ministry-of-solidarity-and-communications-new.component.html',
  styleUrls: ['./ministry-of-solidarity-and-communications-new.component.scss'],
  providers: [
    ]
})

export class MinistryOfSolidarityAndCommunicationsNewComponent extends AppBaseComponent implements OnInit {
...
officeTypeSelectOptions: MaterialSelectOptions;
  ...
  constructor(injector: Injector,
    @Optional() public dialogRef: MatDialogRef<MinistryOfSolidarityAndCommunicationsNewComponent>,
  ...
  onSubmit() {
    this.ministryOfSolidarityAndCommunicationsService.create(this.ministryOfSolidarityAndCommunicationsForm.value)
        .pipe(switchMap(x => {
