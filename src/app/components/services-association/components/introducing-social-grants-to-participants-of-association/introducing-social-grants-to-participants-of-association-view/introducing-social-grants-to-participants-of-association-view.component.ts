...
@Component({
  selector: 'app-introducing-social-grants-to-participants-of-association-view',
  templateUrl: './introducing-social-grants-to-participants-of-association-view.component.html',
  styleUrls: ['./introducing-social-grants-to-participants-of-association-view.component.scss'],
  providers: []
})

export class IntroducingSocialGrantsToParticipantsOfAssociationViewComponent extends AppBaseComponent implements OnInit {
...
caseSelectOptions: MaterialSelectOptions;
  ...
  constructor(injector: Injector,
    ...
    @Optional() public dialogRef: MatDialogRef<IntroducingSocialGrantsToParticipantsOfAssociationViewComponent>,
  ...
  employeeCode : [this.selectedIntroducingSocialGrantsToParticipantsOfAssociation.employeeCode],
  membershipNo : [this.selectedIntroducingSocialGrantsToParticipantsOfAssociation.membershipNo],
  exchangeDate : [this.selectedIntroducingSocialGrantsToParticipantsOfAssociation.exchangeDate],
  exchangeValue : [this.selectedIntroducingSocialGrantsToParticipantsOfAssociation.exchangeValue],
  deceasedName : [this.selectedIntroducingSocialGrantsToParticipantsOfAssociation.deceasedName],
  ...
  disableControls() {
    for (const control of Object.keys(this.introducingSocialGrantsToParticipantsOfAssociationForm.controls)) {
      this.introducingSocialGrantsToParticipantsOfAssociationForm.controls[control].disable();
    }
  }
