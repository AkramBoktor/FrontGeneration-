...
@Component({
  selector: 'app-school-are-excluded-from-quality-control-edit',
  templateUrl: './school-are-excluded-from-quality-control-edit.component.html',
  styleUrls: ['./school-are-excluded-from-quality-control-edit.component.scss'],
  providers: []
})

export class SchoolAreExcludedFromQualityControlEditComponent extends AppBaseComponent implements OnInit {
  ...
  constructor(injector: Injector,
    ...
    @Optional() public dialogRef: MatDialogRef<SchoolAreExcludedFromQualityControlEditComponent>,
  ...
  id : [this.selectedSchoolAreExcludedFromQualityControl.id],
  ...
  onSubmit() {
    this.schoolAreExcludedFromQualityControlService.update(this.schoolAreExcludedFromQualityControlForm.value, this.getControls('id').value)
    .pipe(switchMap(x => {
