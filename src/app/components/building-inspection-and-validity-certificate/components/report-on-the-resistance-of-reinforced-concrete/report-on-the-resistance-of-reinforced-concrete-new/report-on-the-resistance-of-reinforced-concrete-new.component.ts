...
@Component({
  selector: 'app-report-on-the-resistance-of-reinforced-concrete-new',
  templateUrl: './report-on-the-resistance-of-reinforced-concrete-new.component.html',
  styleUrls: ['./report-on-the-resistance-of-reinforced-concrete-new.component.scss'],
  providers: [
    ]
})

export class ReportOnTheResistanceOfReinforcedConcreteNewComponent extends AppBaseComponent implements OnInit {
...
structuralComponentSelectOptions: MaterialSelectOptions;
  ...
  constructor(injector: Injector,
    @Optional() public dialogRef: MatDialogRef<ReportOnTheResistanceOfReinforcedConcreteNewComponent>,
  ...
  onSubmit() {
    this.reportOnTheResistanceOfReinforcedConcreteService.create(this.reportOnTheResistanceOfReinforcedConcreteForm.value)
        .pipe(switchMap(x => {
