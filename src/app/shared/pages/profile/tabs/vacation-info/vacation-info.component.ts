...
import { VacationEmployeeService } from '../../../../../components/vacation/components/vacation-employee/shared/vacation-employee.service';


@Component({
  selector: 'app-vacation-info',
  templateUrl: './vacation-info.component.html',
  styleUrls: ['./vacation-info.component.scss']
})
export class VacationInfoComponent extends AppBaseComponent implements OnInit {
...
vacationsTypeSelectOptions: MaterialSelectOptions;
  ...
  gridHeaderOptions = new GridHeaderOptions({actionColumn: false});
    constructor(
        injector: Injector,
